...
public interface ValidationConstants {
    ...
    String RIDE_STATUS_PATTERN = "WAIT_FOR_PASSENGER|IN_PROGRESS|RECALCULATED|COMPLETED|CANCELLED";
    String NOTIFICATION_STATUS = "ACCEPTED|REJECTED";
    String STATUS_WAIT_FOR_PASSENGER = "WAIT_FOR_PASSENGER";
    String STATUS_IN_PROGRESS = "IN_PROGRESS";
    String NOTIFICATION_ACTIVITY_PATTERN = "ACTIVE|NON_ACTIVE";
    String NOTIFICATION_STATUS_PATTERN = "ACCEPTED|REJECTED|NON_VIEWED";
    String NOTIFICATION_TYPE_PATTERN = "CASH_CONFIRMATION|RIDE_CREATION";
